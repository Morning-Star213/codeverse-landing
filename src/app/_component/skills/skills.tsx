    ...
    >
      ...
      <div className="xl:pl-[190px] lg:pl-[110px] md:pl-[90px] sm:pl-[50px] pl-5">
        <div className="flex sm:pt-5 pr-[40px] pt-5">
          ...
          <div
            className="border-gray-400 border-b-2 w-[93%] flex flex-col sm:flex-row justify-between hover:border-gray-600 text-white hover:text-gray-400 transition delay-100 "
            ...
            >
              <div className="">
                <div className="text-[9px] lg:text-[10px] xl:text-[13px]">
                  ...
                  with ASP.NET. This diverse range of capabilities allows us to
                  tackle complex server-side challenges and deliver robust,
        ...
        <div className="flex sm:pt-5 pr-[40px] pt-5">
          ...
          >
            ...
            >
              <div className="">
                <div className="text-[9px] text-[9px] lg:text-[10px] xl:text-[13px]">
